        ...
        <div className="max-w-[1400px] mx-auto px-5 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { href: '/event-center', title: 'Banquet Hall & Event Center', desc: 'Weddings, showers, milestones, sports teams, celebrations of life. Up to 200 seated (350 standing cocktail) with in-house or outside catering.' },
            ].map((item) => (
              <Link
                key={item.href}
                href={item.href}
